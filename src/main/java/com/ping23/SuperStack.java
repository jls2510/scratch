...
public class SuperStack
{
    ...
    {
        Scanner in = new Scanner(FileUtilities.getFileFromRelativeFullPath("/main/java/com/ping23/input006.txt"));
    ...
    static void superStack(String[] operations)
    {
        ...
        for (int opIndex = 0; opIndex < operations.length; opIndex++)
        {
            ...
            matcher.find(); // this assumes there will be only one operation per line
            ...
            if (verb.equals("pop"))
            {
                ...
                {
                    System.out.println(stackArray[currentTopIndex]);
                }
                continue;
            }
            ...
            if (verb.equals("push"))
            {
                ...
                // length
                // depending on usage and size I might try to optimize this by shrinking
                // it back down at some point if there's a lot of unused capacity
    ...
    private static final String INPUT_2 = "8\r\n" + 
        "push -36\r\n" + 
        "push 20\r\n" + 
        "pop \r\n" + 
        "push -9\r\n" + 
